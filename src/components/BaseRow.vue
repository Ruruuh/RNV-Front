...
<template>
    <section :class="props.mode">
        ...
        <base-progress v-if="props.mode !== 'ticket' && props.mode !== 'create'" :actionBy="actionBy"></base-progress>
        ...
        <div v-if="props.mode === 'ticket'" class="row__actions">
            <base-toggle v-if="props.mode === 'ticket'" @click="passReimbursementId" :approved="props.approved"></base-toggle>
        </div>
    </section>
</template>
